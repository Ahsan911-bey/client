    ...
    return(
        <div className='flex justify-left'>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5'>
                {AnimeList.map((anime) =>(
                    <div key={anime.id} className='group relative mt-4 shadow-inner bg-black overflow-hidden transition ease-in-out hover:scale-105 duration-300'>
                        ...
                        <div className='group-hover:opacity-60 absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-55'></div>
                            ...
                            {anime.nsfw && (
                                <div className='absolute bg-red-500 top-0 left-2 px-1 py-0.5 rounded-md text-sm'>18+</div>
                            )}
